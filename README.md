...
A: Because servers don't have state and can't 'remember' things. Sessions
essentially provide a way to persist data across requests.
1. What does bcrypt do to help us store passwords in a secure manner.
A: It adds a long random string called 'salt' which is like a password for 
verifying the password.
1. What does bcrypt do to slow down attackers?
A: It does several rounds of hashing.
